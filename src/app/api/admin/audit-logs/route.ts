 ...
 *
 * Query params:
 *   search       string â€” searches action, entityType, and entityId (optional)
 *   entityType   string â€” exact match (optional)
 *   action       string â€” exact match (optional)
 *   from         ISO date string (optional)
 *   to           ISO date string (optional)
 *   page         integer >= 1 (default: 1)
 *   limit        integer 1â€“100 (default: 50)
 *
